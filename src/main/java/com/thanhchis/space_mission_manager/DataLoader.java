...
@Component // Báo cho Spring biết đây là một Bean cần được quản lý
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        // Chỉ chạy khi database hoàn toàn trống
    ...
    private void loadSampleData() {
        // --- 5 MẪU DỮ LIỆU ĐẠI DIỆN ---

        // Mẫu 1: Nhiệm vụ có người lái thành công cao, nhiều phi hành gia
        ...
        // Mẫu 2: Nhiệm vụ không người lái (Robot)
        Mission m2 = new Mission("Europa Clipper", "EC-01", "Europa (Jupiter Moon)", 2030, 95.0, false);

        // Mẫu 3: Nhiệm vụ thám hiểm Sao Hỏa có người lái
        ...
        // Mẫu 4: Nhiệm vụ tư nhân (SpaceX)
        Mission m4 = new Mission("Starship Cargo Run", "SCR-03", "Mars Orbit", 2029, 92.7, false);

        // Mẫu 5: Nhiệm vụ rủi ro cao, tỉ lệ thành công thấp hơn
